...
def parse_args():
    ...
    parser.add_argument("--max_episode", type=int, default=100, help="maximum episode length")
    ...
    parser.add_argument("--lr_a", type=float, default=0.01, help="learning rate for adam optimizer")
    parser.add_argument("--lr_c", type=float, default=0.02, help="learning rate for adam optimizer")
    parser.add_argument("--gamma", type=float, default=0.95, help="discount factor")
    parser.add_argument("--batch_size", type=int, default=128, help="number of episodes to optimize at the same time")
    parser.add_argument("--memory_size", type=int, default=1000, help="number of data stored in the memory")
    parser.add_argument("--num_units_1", type=int, default=30, help="number of units in the mlp")
    parser.add_argument("--num_units_2", type=int, default=20, help="number of units in the mlp")
    parser.add_argument("--num_units_openai", type=int, default=30, help="number of units in the mlp")
    ...
    parser.add_argument("--old_model_name", type=str, default="models/simple_adversary_2109_271536_370000/", \
